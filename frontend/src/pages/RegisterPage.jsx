...
const RegisterPage = () => {
  ...
  function register() {
    if (password === cpassword) {
      ...
      console.log("New customer registered successfully:", newCustomer);
      // Add logic to send newCustomer data to your backend here
    } else {
      ...
      <div className="bg-[#333333] shadow-md rounded-md p-6">
        ...
        <form className="space-y-6" method="POST" onSubmit={(e) => e.preventDefault()}>
          ...
          <div className="flex w-full justify-center py-2 px-4 text-sm shadow-sm hover:bg-opacity-75">
            <Button2 text="Register Account" onClick={register} />
          </div>
        </form>
